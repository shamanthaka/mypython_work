...
class Employee:
    ...
    def __init__(self, first_name, last_name, email, pay):    # constructor
        ...
        self.email = email
        self.pay = pay
        Employee.no_of_employees += 1  # Employee.no_of_employees = Employee.no_of_employees + 1
    ...
    def from_string(cls, emp_str):     #alternative constructor or class method
        first, last, email, pay = emp_str.split('-')  #james-mark-james@gmail.com-67676
